...
Namespace PaymentsDataSetTableAdapters
    ...
    Partial Public Class PaymentsTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As PaymentsDataSet.PaymentsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As PaymentsDataSet.PaymentsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As PaymentsDataSet.PaymentsDataTable = New PaymentsDataSet.PaymentsDataTable()
