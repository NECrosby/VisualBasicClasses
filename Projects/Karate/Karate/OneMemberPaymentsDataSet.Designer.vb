...
Partial Public Class OneMemberPaymentsDataSet
    ...
    Partial Public Class PaymentsDataTable
        ...
        Public Overloads Function AddPaymentsRow(ByVal parentMembersRowByFK_Payments_Members As MembersRow, ByVal Payment_Date As Date, ByVal Amount As Decimal) As PaymentsRow
            ...
            Dim columnValuesArray() As Object = New Object() {Nothing, Payment_Date, Amount}
            If (Not (parentMembersRowByFK_Payments_Members) Is Nothing) Then
                columnValuesArray(0) = parentMembersRowByFK_Payments_Members(0)
            End If
...
Namespace OneMemberPaymentsDataSetTableAdapters
    ...
    Partial Public Class MembersTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Last_Name + ', ' + First_Name AS FullName FROM dbo.Members ORDER BY La"& _ 
                "st_Name"
